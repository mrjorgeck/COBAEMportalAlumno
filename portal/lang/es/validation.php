...
return [
    ...
    'attributes' => [
        'curp' => 'CURP',
        'folio_examen' => 'folio de examen',
        'folio_examen_confirmacion' => 'confirmación del folio de examen',
        'semestre_solicitado' => 'semestre solicitado',
        'tipo_estudiante_id' => 'tipo de estudiante',
        'paraescolar_id' => 'paraescolar',
        'nombres' => 'nombre(s)',
        ...
        'municipio_nacimiento_id' => 'municipio de nacimiento',
        ...
        'entidad_secundaria_id' => 'entidad de la secundaria',
        'municipio_secundaria_id' => 'municipio de la secundaria',
        'secundaria_nombre' => 'nombre de la secundaria',
        'tipo_secundaria_id' => 'tipo de secundaria',
        'turno_secundaria_id' => 'turno de secundaria',
        'promedio_secundaria' => 'promedio de secundaria',
        'tutor_nombres' => 'nombre(s) del tutor',
        'tutor_primer_apellido' => 'primer apellido del tutor',
        'tutor_segundo_apellido' => 'segundo apellido del tutor',
        'tutor_telefono' => 'teléfono del tutor',
        'tutor_celular' => 'celular del tutor',
        'tutor_ocupacion_id' => 'ocupación del tutor',
        'tutor_estudios_id' => 'estudios del tutor',
        'madre_nombres' => 'nombre(s) de la madre',
        'madre_primer_apellido' => 'primer apellido de la madre',
        'madre_segundo_apellido' => 'segundo apellido de la madre',
        'madre_telefono' => 'teléfono de la madre',
        'madre_celular' => 'celular de la madre',
        'madre_ocupacion_id' => 'ocupación de la madre',
        'madre_estudios_id' => 'estudios de la madre',
        'no_seguro_medico' => 'número de seguro médico',
        'beca_id' => 'beca',
        'estatura' => 'estatura',
        'peso' => 'peso',
        'tipo_sangre_id' => 'tipo de sangre',
        'acepto_privacidad' => 'aviso de privacidad',
        ...
        'ciclo_ingreso_id' => 'ciclo de ingreso',
